const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2021-05-20', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: 'Welcome to VPSLIST', url: 'https://www.vpslist.net' },
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: 'Best VPS',
  HEO_HERO_TITLE_2: 'Recommendation Sites',
  HEO_HERO_TITLE_3: 'VPSLIST.NET',
  HEO_HERO_TITLE_4: 'Latest Hot Articles',
  HEO_HERO_TITLE_5: '4 Best Vietnam VPS',
